...
|----|------|----------|--------|-----------|------------|-------|--------|
| RISK-01 | Live Groq/OpenAI keys were committed to the repo | Critical | Credential compromise, billing abuse | High (if pushed) | Files cleaned + `.env` ignored; **rotate keys at providers** | User | **Open (rotation pending)** |
...
| RISK-04 | Streamlit UI not browser-verified | Medium | UI regressions ship undetected | Medium | Manual UI smoke checklist in [test-strategy](06-test-strategy.md) | QA | Open |
