...
> **Document:** Test Strategy · **Version:** 1.11 · **Status:** Baseline · **Owner:** QA/Engineering · **Last updated:** 2026-06-12
...
**293 automated tests pass locally** (160 through Phase 5 + 25 in Phase 6 + 57 in Phase 6.5 + 20 in Round C1 + 31 in Phase 7):
...
| 1.11 | 2026-06-12 | QA/Eng | Phase 7 review r1 remediation: +4 tests (`ebs_modules` unknown→422 + known-lowercase; `/v1/execute`+`/v1/nl2sql` auth) → **293 total**. |
