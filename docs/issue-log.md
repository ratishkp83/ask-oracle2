...
> **Document:** Issue Log · **Version:** 1.18 · **Status:** Living · **Owner:** Engineering · **Last updated:** 2026-06-15 (Phase-9 B6 + B7 + post-B7 hardening: **BUG-009** [error-readability] + **BUG-010** [off-topic NL guard, ADR-025] FIXED; open = **ITM-026** + **ITM-031** + **ITM-034** [B-4 label nit])
