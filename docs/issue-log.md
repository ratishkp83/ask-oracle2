...
> **Document:** Issue Log · **Version:** 1.19 · **Status:** Living · **Owner:** Engineering · **Last updated:** 2026-06-15 (Phase-9 B6 + B7 + post-B7 hardening: **BUG-009** [error-readability], **BUG-010** [off-topic NL guard], **BUG-011** [no-proxy for missing columns] — all FIXED via ADR-024/025; open = **ITM-026** + **ITM-031** + **ITM-034**)
